          ...
          <c:if test="${wdkAnswer.useCheckboxTree}">
            ...
            <tr>
              <td colspan="${numPerLine}">
                ...
                <imp:checkboxTree id="selectedFieldsCBT" rootNode="${wdkAnswer.reportMakerAttributeTree}" checkboxName="selectedFields" showSelectAll="false" showResetCurrent="true"/>
              </td>
            </tr>
          </c:if>
